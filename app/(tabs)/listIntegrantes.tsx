/***************************************************************
 * Nombre: listIntegrantes.tsx
 *
 * Descripción:
 * Pantalla que lista los integrantes de un
 * campeonato mundial. Permite filtrar entre
 * jugadores y cuerpo técnico, además de
 * crear, editar y eliminar integrantes.
 *
 * Autor: Grupo 3
 *
 * Fecha: 17/05/2026
...
export default function ListIntegrantes() {
  ...
  const [filtro, setFiltro] =
    useState<'todos' | 'jugadores' | 'staff'>('todos');
    ...
    <View style={styles.card}>
      ...
      <View
        style={[
          styles.avatar,
          {
            backgroundColor: item.int_es_jug
              ? COLORS.primaryLight
              : COLORS.successLight
          }
        ]}
  ...
  return (
    <View style={globalStyles.screen}>
      ...
      <View style={[styles.summary, { paddingTop: insets.top + SPACING.sm }]}>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                router.replace({
                  ...
                  params: { paisGanadorId, nombrePais }
                } as any);
              }}
            >
